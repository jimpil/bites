...
(def ^:const ^int  MAX_UNSIGNED_SHORT  (int 65535))
(def ^:const ^long MAX_UNSIGNED_INT    (long 4294967295))
(def ^:const ^BigInteger MAX_UNSIGNED_LONG   (biginteger 18446744073709551615N))
